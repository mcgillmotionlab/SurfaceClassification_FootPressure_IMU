...
\begin{figure}[H]
    ...
    \centering\includegraphics[width=18cm, trim=0cm 1cm 0cm 0cm,
...
\midrule
Chen et al.~\cite{Chen2019} & 30 healthy (15 women), \mbox{24.0 $\pm$ 1.1 y} & urban flat; incline/decline; stairs & IMU on exterior left shoe & CNN & random split \(\dagger\) & Acc: DL 87.74; custom 84.02 & --- \\
\midrule
...
\begin{figure}[H]
    ...
    % AUTHOR: done, added high resolution pdf version of image.
...
\hl{IEE Smart Sensing Solutions.} %MDPI: We changed to full name and removed the repeated contents. Please confirm. Please provide the correct title.
  2018. \hl{Available online: }%MDPI: We are sorry but we could not find the required information about this entry. Please provide the URL of the website and the date it was accessed (Date Month Year). Please refer to https://www.mdpi.com/authors/references for full reference formatting guides.
{\changeurlcolor{black}\url{https://iee-sensing.com/health-tech/}}(accessed on 8 April 2025).
% AUTHOR: updated
...
{\changeurlcolor{black}\url{https://zenodo.org/records/17992932}} (\hl{accessed on 8 April 2025}).%MDPI: Please add the access date (format: Date Month Year), e.g., accessed on 1 January 2020. Please note that the access date should be before the paper received date 
% AUTHOR: updated and changed url color to black
...
Chen, T.; Guestrin, C.
 ...
 In Proceedings of the 22nd ACM SIGKDD
  ...
  NY, USA, \hl{13--17 August} 2016; pp. 785–794. {\changeurlcolor{black}\url{https://doi.org/10.1145/2939672.2939785}}.
% AUTHOR: OK
